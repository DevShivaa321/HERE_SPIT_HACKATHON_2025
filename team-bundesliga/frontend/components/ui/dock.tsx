  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          "mx-auto flex w-fit gap-4 rounded-2xl bg-gray-50/80 backdrop-blur-md px-4 dark:bg-neutral-900/80 border border-gray-200 dark:border-gray-800",
          className,
        )}
...
function DockIcon({ children, className, width }: DockIconProps) {
  const widthTransformInitial = useMotionValue(20)
  const widthTransform = width ? useTransform(width, (val) => val / 2) : widthTransformInitial
